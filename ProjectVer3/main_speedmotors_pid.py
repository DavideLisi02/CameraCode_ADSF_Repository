...
def start_video_stream_fun(URL, q):
        ...
        try:
            ...
            while not stop_event.is_set() and not restart_loop:
                ...
                if reflection_xy[1]:
                    ...
                    threaded_started = False
                    if i ==10:
                        control_thread = threading.Thread(target=move_motors, args=(i_1,i_2,esp32))
                        control_thread.start()
                        threaded_started = True
                    elif i>50:
                        if threaded_started:
                            i=0
                            control_thread.join()
