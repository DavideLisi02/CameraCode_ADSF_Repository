...
def move_motors(i1,i2,esp32):
    ...
    [i1,i2] : list
    '''
    global previous_thread_finished
    print("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]")
...
def control_motors(x_p,y_p,x_r,y_r,esp32):
    ...
    i_1 = int(0.1*(x_p-x_r)+90)
    i_2 = int(0.1*(y_p-y_r)+90)
...
def start_video_stream_fun(URL, q, desired_fps=10, sleep_time=0.01): # Added sleep_time parameter
    ...
    while not stop_event.is_set():
        try:
            ...
            if not success:
                print(f"Could not set frame rate to {desired_fps} fps.")
                q.put({"error": f"Could not set frame rate to {desired_fps} fps."})
                break
            '''
